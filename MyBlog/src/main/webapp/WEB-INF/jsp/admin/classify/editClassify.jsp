                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
					<!-- BEGIN FORM-->
					<form action="classify/editClassify.action" method="post" id="form_sample_1" class="form-horizontal">
						<fieldset>
							...
							<div class="alert alert-success hide">
  							...
  							<div class="control-group">
  								...
  								<div class="controls">
  									<input type="text" id="classifyName" name="classifyName" value="${classify.classifyName}" data-required="1" class="span6 m-wrap"/>
  								</div>
  							</div>
                             <input type="hidden" id="classifyId" name="classifyId" value="${classify.classifyId}" />
